...
def sign_in():
    ...
    print("\n========== ENTER FIRST ADMIN INFO ==========")
    a_name = input("Enter Admin Name: ").strip()
    a_last_name = input("Enter Admin Last Name: ").strip()
    a_password = input("Enter Admin Password: ").strip()
    print(controller.register_admin(a_name, a_last_name, a_password))
    return "admin"
